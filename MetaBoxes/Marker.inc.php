...
class Marker {
    ...
    function create_meta_box( $post ){
        ...
        Latitude: <input type="number" step="any" name="latitude" value="<?php echo $latitude; ?>" placeholder="Enter a latitude" required/><br />
        Longitude: <input type="number" step="any" name="longitude" value="<?php echo $longitude; ?>" placeholder="Enter a longitude" required/>
