...
class EmergencyPhones{
    ...
    private $emergency_phone_marker;
    ...
    public function __construct(){
        ...
        $this->emergency_phone_marker = new Marker( $this->slug, $this->singular_label );
    ...
    function meta_box_callback(){
        add_meta_box( $this->slug . '-address', $this->singular_label . ' Location', array( $this->emergency_phone_marker, 'location_meta_box' ), $this->slug, 'side');
    }
}